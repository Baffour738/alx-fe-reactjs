const UserProfile = (props) => {
  return (
    <div style={{ border: '1px solid #ccc', padding: '12px', margin: '12px', borderRadius: '8px', backgroundColor: '#f9fafb' }}>
      <h2 style={{ color: '#1e40af', margin: '0 0 8px 0', fontSize: '1.5rem' }}>{props.name}</h2>
